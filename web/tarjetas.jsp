  ...
  <div class="card">
    ...
    <div class="side back">
      <div class="info">
        ...
        <ul>
          <li>Monitoreo del espectro electromagnético: Recolección de ondas electromagnéticas, en particular las bandas satelitales y de VHF/UHF en zonas protegidas ambientalmente.</li>
          <li>Monitoreo del espectro </li>
          <li>Monitoreo del espectro </li>
        </ul>
        <div class="btn">
          <a href="vistaproyecto.jsp" >LEARN MORE</a>
